...
"%2\$s has been revised %1\$s to the revision of %3\$s" => "%2\$s has been revised %1\$s to the revision of %3\$s",
...
"Tags" => "Tags",
"This are your example tags." => "These are your example tags.",
"Tags can be assigned to passwords, giving them common properties like minimal" => "Tags can be assigned to passwords, giving them common properties like minimal",
...
"While a \"forums\" tag requires a " => "While a \"forums\" tag requires a ",
...
"This key is used to encrypt all your sensive data." => "This key is used to encrypt all your sensitive data.",
"This key is private and never send to the server" => "This key is private and never sent to the server",
...
"to expand an menu to display various options for an item." => "to expand a menu to display various options for an item.",
...
"Eg: The label of the item, Login / username, email." => "Eg: The label of the item, Login / username, email.",
"Also there is an password field." => "Also there is a password field.",
"Password" => "Password",
...
"It has an build in password generator with many settings." => "It has a built-in password generator with many settings.",
"Files" => "Files",
"You can upload files, with a max of 5Mb." => "You can upload files, with a max of 5MB.",
"Files are first encrypted with your encryption key and then send to the server." => "Files are first encrypted with your encryption key and then sent to the server.",
...
"If the default fields are not enough your you, then here you can add your own fields." => "If the default fields are not enough for you, then you can add your own fields here.",
...
"Passman has a build in OTP (One Time Password) generator." => "Passman has a build in OTP (One Time Password) generator.",
"If you don't know what a OTP is then i suggest you enable it." => "If you don't know what an OTP is then I suggest you enable it.",
...
"Enter the 2 factor secret" => "Enter the 2 factor secret",
...
"Here you can indentify weak passwords, we will list the items. List all password with a rating less\n              than" => "Here you can indentify weak passwords, we will list the items. List all password with a rating less\n              than",
"Score" => "Score",
"edit" => "edit",
"Drag this to your browser bookmarks and click it, when you want to save username / password quickly" => "Drag this to your browser bookmarks and click it, when you want to save username / password quickly",
...
" Generating sharing keys, this is a one time thing, please wait." => " Generating sharing keys, this is a one time thing, please wait.",
"Enter your encryption key." => "Enter your encryption key.",
"If this if the first time you use Passman, this key will be used for encryption your\n    passwords" => "If this is the first time you use Passman, this key will be used to encrypt your\n    passwords",
"Remember this key " => "Remember this key ",
"%n minute::%n minutes" => array("%n minute","%n minutes"),
"%n hour::%n hours" => array("%n hour","%n hours"),
"%n day::%n days" => array("%n day","%n days"),
"Minimal password scope" => "Minimal password scope",
"Override required score" => "Override required score",
"Current password scope" => "Current password scope",
"Password will expire at " => "Password will expire at ",
"Enter your encryption key. If this if the first time you use Passman, this key will be used for encryption your\r\n    passwords" => "Enter your encryption key. If this if the first time you use Passman, this key will be used for encryption your\n    passwords",
"Minutes" => "Minutes",
"Hours" => "Hours",
"Day" => "Day",
"Days" => "Days"
