...
<div ng-app="passman" id="app" ng-controller="appCtrl">
  ...
  <div id="app-content" ng-controller="contentCtrl">
    <div id="topContent">
      ...
      <button class="button" id="editItem" ng-click="editItem(currentItem)"
              ng-show="currentItem">Edit item</button>
      <button class="button" id="deleteItem" ng-click="deleteItem(currentItem,true)"
              ng-show="currentItem">Delete item</button>
    </div>
    <ul id="pwList">
          ...
          <td>
                      ...
                      <span ng-if="custom.clicktoshow==1">
                       <span pw="custom.value" toggle-text-stars></span> <a clip-copy="custom.value"
                                                                            clip-click="copied(custom.label)" class="link">[Copy]</a>
                      </span>
          </td>
        </tr>
        </tbody>
  ...
  <!-- Add / edit item -->
    <div id="editAddItemDialog" style="display: none;" ng-controller="addEditItemCtrl">
      ...
      <form method="get" name="new_item" id="editNewItem">
        <div id="item_tabs">
          ...
          <div id="tabs-01">
            ...
            <label for="email" class="label_cpm">Email </label>
            <input type="text" name="email" ng-model="currentItem.email" autocomplete="off">
            <label for="url" class="label_cpm">URL</label>
          ...
          <div id="tabs-02">
            <div>
              <span>Minimal password score:</span><span
                id="complex_attendue">{{requiredPWStrength}}</span>
              <label class="label_cpm"><input type="checkbox"
                                              ng-model="currentItem.overrrideComplex">Override required score
              </label>
            </div>
            ...
            <input ng-show="!pwFieldVisible" type="password" name="password" ng-model="currentItem.password"
                   autocomplete="off">
            <span ng-show="pwFieldVisible" class="pwPreview">{{currentItem.password}} <a clip-copy="currentItem.password"
                                                                                         clip-click="copied('password')"
                                                                                         class="link">[Copy]</a></span>
            ...
            <br/>
            <span ng-show="!newExpireTime">Password will expire at <span
                ng-bind="currentItem.expire_time | date"></span></span>
            <span ng-show="newExpireTime">Password will expire at <span
                ng-bind="newExpireTime | date"></span></span>

            <div id="pwTools">
                            <span id="custom_pw">
                                <span>Password Length</span> <input type="number"
                                                                                          ng-model="pwSettings.length"
                                                                                          style="width:30px"><br>
              ...
              <button class="button" ng-show="generatedPW!=''"
                      ng-click="usePw()">Use password</button>
      ...
      <button class="button save" ng-click="saveItem(currentItem)"
              ng-disabled="!new_item.$valid">Save</button>
      </div>
    </div>
  <!-- end add / edit item -->
    ...
    <div id="settingTabs">
      ...
      <div id="tabs-2">
        ...
        <p>Morbi tincidunt, dui sit amet facilisis feugiat, odio metus gravida ante, ut pharetra massa metus id nunc. Duis
          ...
          in eros vestibulum mi adipiscing adipiscing. Morbi facilisis. Curabitur ornare consequat nunc. Aenean vel metus.
  ...
  <div id="shareDialog" ng-controller="shareCtrl" style="display: none;" ng-init="tabActive=1">
    ...
    <div class="row tabContent">
      ...
      <div class="col-xs-8" ng-show="tabActive==2">
        <label><input type="checkbox" ng-model="shareSettings.allowShareLink"  ng-click="createShareUrl()"/>Create share link</label>
